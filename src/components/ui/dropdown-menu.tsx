...
// Group for dropdown menu items
const DropdownMenuGroup = DropdownMenuPrimitive.Group

// Portal for the dropdown menu
const DropdownMenuPortal = DropdownMenuPrimitive.Portal

// Sub-menu for the dropdown menu
const DropdownMenuSub = DropdownMenuPrimitive.Sub

// Radio group for dropdown menu items
const DropdownMenuRadioGroup = DropdownMenuPrimitive.RadioGroup

// Sub-trigger for the dropdown menu
...
// Sub-content for the dropdown menu
...
// Shortcut for the dropdown menu
